...
thead.id = 'thead'
thead.innerHTML = '<tr>'
    + '<th>Index<i class="fa-sort float-right"></i></th>'
    + '<th>Icon<i class="fas fa-star float-right"></i></th>'
    + '<th>Name<i class="fas fa-arrow float-right"></i></th>'
    + '<th>Rarity<i class="fas fa-mail float-right"></i></th>'
