...
thead.innerHTML = '<tr id="jobsThead">'
    ...
    + '<th id="thHp" data-sort="number">Lv 10 HP<i class="fas fa-sort float-right"></i></th>'
    + '<th id="thStr" data-sort="number">Lv 10 STR<i class="fas fa-sort float-right"></i></th>'
    + '<th data-sort="number">Lv 10 AGI<i class="fas fa-sort float-right"></i></th>'
    + '<th data-sort="number">Lv 10 INT<i class="fas fa-sort float-right"></i></th>'
    + '</tr>'
