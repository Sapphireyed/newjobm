...
export default () => {
  ...
  + '<div class="dropdown">'
      ...
      +  '<div class="dropdown-content">'
        ...
        +  '<li class="nav-item nav-justified ml-3"><a class="nav-link" href="./chars">Characters</a></li>'
        +  '<li class="nav-item nav-justified ml-3"><a class="nav-link" href="./abils">Abilities</a></li>'
        + '<li class="nav-item nav-justified ml-3"><a class="nav-link" href="./passives">Passives</a></li>'
        + '<li class="nav-item nav-justified ml-3"><a class="nav-link" href="./materials">Materials</a></li>'
        + '<li class="nav-item nav-justified ml-3"><a class="nav-link" href="./chapters">Chapters</a></li>'
        + '<li class="nav-item nav-justified ml-3"><a class="nav-link" href="./gachas">Gachas</a></li>'
      +  '</div>'
  + '</div>'
  + '<div class="dropdown">'
