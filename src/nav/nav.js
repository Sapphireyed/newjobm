...
export default () => {
  ...
  + '</div>'
  + '<div class="dropdown">'
    + '<li class="nav-item nav-justified text-danger ml-3"><a class="nav-link" href="#">Guide</a></li>'
    +  '<div class="dropdown-content">'
      +  '<li class="nav-item nav-justified ml-3"><a class="nav-link" href="guide.html">Guide</a></li>'
      +  '<li class="nav-item nav-justified ml-3"><a class="nav-link" href="faq.html">FAQ</a></li>'
    +  '</div>'
  + '</div>'
  + '<li class="nav-item nav-justified ml-3"><a class="nav-link" id="mCollectionLink" href="credits.html">Credits</a></li>'
  + '</ul>'
  + '</div>'
