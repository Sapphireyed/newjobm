...
thead.innerHTML =  '<tr id="abilsThead">'
    ...
    + '<th style="line-height: 80%">Threshold<br><span style="font-size:12px; font-weight:normal;">(100% | <50% | <30%)</span><i class="fas fa-sort float-right"></i></th>'
  //  + '<th>Stack Increase at<i class="fas fa-sort float-right"></i></th>'
    + '<th>Spoecial<i class="fas fa-sort float-right"></i></th>'
